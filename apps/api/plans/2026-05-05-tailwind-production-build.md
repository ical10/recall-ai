...
- **Railway worker and beat services share the build image** — they'll waste a few seconds compiling CSS they don't use. Acceptable; the alternative (per-service `nixpacks.toml`) is more complex than the win.
